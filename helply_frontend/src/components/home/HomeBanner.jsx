...
export const HomeBanner = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-20 bg-teal-600 p-4 sm:flex-row my-10 lg:mx-40 rounded-xl relative">
      <div className="hidden lg:flex-shrink-0 w-56 sm:block">
      ...
      <div className="flex flex-col gap-y-10">
        ...
        <form className="">
          <div className="relative ">
            ...
            <button
              type="submit"
              className="text-white absolute end-3 bottom-4 bg-teal-600 hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Search
            </button>
          </div>
      ...
      <div className="hidden lg:flex-shrink-0 w-64 sm:block">
        <div
          className="hidden lg:flex-shrink-0 w-44 sm:block"
